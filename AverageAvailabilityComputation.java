...
public class AverageAvailabilityComputation
{
    ...
    private String outputFile = "averagesEvery" + intervalMinutes + "Minutes_4_6_12-5_5_12.csv";
    private String dataFile = "dbProjection_4_6_12-5_5_12.csv";
    ...
    public AverageAvailabilityComputation()
    {
        ...
        try
	{
                ...
                for ( int j = 0; j < blockList.size(); j++ )
		{
                        ...
                        if ( !tooLongAgo(new Timestamp(availabilityData[1]),currentTime) )
			{
                    ...
                    double avgAvailability = (double)currentTotal/(double)currentCount;
                    fw.write(currentBlock + "," + avgAvailability + "," + currentTime + "," + currentTotal + "," + currentCount + "\n");
    ...
    {
        AverageAvailabilityComputation aac = new AverageAvailabilityComputation();
    }
}
